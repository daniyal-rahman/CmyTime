TITLE Mod file for component: Component(id=generic_muscle_iaf_cell type=iafCell)
...
PROCEDURE rates() {
    ...
    ? DerivedVariable is based on path: synapses[*]/i, on: Component(id=generic_muscle_iaf_cell type=iafCell), from synapses; null
